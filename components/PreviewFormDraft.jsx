...
function PreviewFormDraft({ data }) {
  ...
  const inputElements = {
    shortAnswer: (
      <input
        type="text"
        className="w-full h-auto rounded-lg border py-[6px] px-2 gap-1 bg-white border-[#E1E4E8] hover:shadow-bx placeholder:text-[#959DA5] text-[#0D0D0D] focus:outline-[#219653]"
      />
    ),
    longAnswer: (
      <textarea
